            ...
            <div className="relative">
                ...
                >
                    <>
                        {
                            data?.map(a => {
                                return <SwiperSlide key={a.id} className='my-8'>
                                    <div className='bg-[#f2f4f6] h-[500px] w-full grid grid-cols-1 lg:grid-cols-2  items-center gap-4 p-4'>
                                        ...
                                        <div className='w-full'>
                                            <h1 className='text-6xl font-bold mb-4'>{a.title}</h1>
                                            <p>{a.description}</p>
                ...
                {/* Custom Buttons */}
                <div className="absolute z-10 top-1/2 lg:-left-6 left-5 transform -translate-y-1/2">
                    <button
                        ref={prevRef}
                ...
                <div className="absolute z-10 top-1/2 lg:-right-6 right-5 transform -translate-y-1/2">
                    <button
                        ref={nextRef}
                        disabled={isEnd}
